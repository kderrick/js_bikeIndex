...
$(document).ready(function() {
  $('#buttonSubmit').click(function() {
    ...
    $.get('https://bikeindex.org:443/api/v2/bikes_search/stolen?per_page=100&colors=' + newBike.frameColor +'&manufacturer=' + newBike.brand + '&proximity=' + newBike.city + '%2C%20'+ newBike.state + '&access_token=2snw8x3hz9tiuh9gek0lca', function(response) {
